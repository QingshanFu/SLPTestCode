    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user.Count > 0)
            {
                ...
                ViewData["LoginUser"] = GetLoginUser(this);

                return RedirectToAction("Main", "SLPValidationMain");
            }
            else
            {
        ...
        public static LoginUser GetLoginUser(Controller control)
        {
            if (control.Session["UserInfo"] == null)
            {
            ...
            {
                return (LoginUser)(control.Session["UserInfo"]);
            }
        }
    }
